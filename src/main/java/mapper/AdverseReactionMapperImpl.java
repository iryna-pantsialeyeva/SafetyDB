...
public class AdverseReactionMapperImpl implements AdverseReactionMapper {
    ...
    public AdverseReaction fromFields(
        ...
        AdverseReaction reaction = new AdverseReaction(description, suspectedDrug, Outcome.getOutcomeByLabel(outcome),
                Criteria.getCriteriaByLabel(criteria), new User(0),
                RelationshipType.getRelationshipTypeByLabel(supposedDrugOutcomeCriteria),
    ...
    public AdverseReaction toDto(AdverseReaction dto) {
        return new AdverseReaction(dto.getDescription(), dto.getSuspectedDrug(), dto.getOutcome(), dto.getCriteria(),
                null, dto.getNameGivenByReporter(), dto.getTimeRelationship(), dto.getWithdrawalResult(),
                dto.getReintroductionResult(), dto.getOtherExplanation());
    }
}
